...
import { GeminiConfig, GeminiResponse, GeminiError } from '../../types/gemini.types'
...
export class GeminiClient {
  ...
  async generate(prompt: string, options: Partial<GeminiConfig> = {}): Promise<GeminiResponse> {
  ...
  async *generateStream(prompt: string, options: Partial<GeminiConfig> = {}): AsyncGenerator<GeminiResponse, void, unknown> {
    const config = { ...this.config, ...options }
